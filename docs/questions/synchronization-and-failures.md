...
5. **SYNC-05** 已迁移到[全局不变量问题 `INVARIANT-05`](../xv6-tutorial/questions/global-invariants.md#invariant-05原-sync-05耗尽为什么有五种不同结果)。此处只保留兼容入口。
...
8. **SYNC-08** 已迁移到[全局不变量问题 `INVARIANT-08`](../xv6-tutorial/questions/global-invariants.md#invariant-08原-sync-08提高-nproc-会改变哪些隐含上界)。此处只保留兼容入口。
